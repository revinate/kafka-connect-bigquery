...
public class BigQueryRecordConverterTest {
    ...
    @Test(expected = ConversionConnectException.class)
    public void testRecordKeyWhenNotStruct() {
        SinkRecord kafkaConnectRecord = spoofSinkRecordKey(Schema.BOOLEAN_SCHEMA, false);
        new BigQueryRecordConverter(SHOULD_CONVERT_DOUBLE).convertRecordKey(kafkaConnectRecord);
    }

    @Test
    public void testRecordKeyWhenStruct() {
        final String fieldName = "id";
        final String fieldValue = "1000044";
        ...
        SinkRecord kafkaConnectRecord = spoofSinkRecordKey(kafkaConnectSchema, kafkaConnectStruct);
    ...
    private static SinkRecord spoofSinkRecordKey(Schema keySchema, Object key) {
        return new SinkRecord(null, 0, keySchema, key, null, null, 0);
    }
}
